          ...
          {imagesMobi.map((image, index) => (
            <SwiperSlide key={index}>
              ...
              <div className="absolute bottom-[40px] left-[35%]">
                <h3 className="text-[24.41px] font-normal leading-[27px] text-center text-white mb-4">
                  Chicky Run
                </h3>
                <div className="flex justify-center">
                  <p className="text-[13.78px] font-normal leading-[13px] text-center text-white">
                    Game Details
                  </p>
                  <img
                    className="w-3 h-3 cursor-pointer ml-2"
                    src="/next-white-icon.png"
                    alt="Next"
                  />
                </div>
              </div>
