    ...
    <section className="mt-10">
      ...
      <div className="hidden md:grid grid-cols-1 lg:grid-cols-2 gap-6">
        {categories.map((category, index) => (
          <div
            key={index}
            className="bg-[#0000000D] rounded-3xl overflow-hidden p-6"
          >
              ...
              <div className="flex flex-col h-full flex-1">
                ...
                >
                  <img
                    ...
                    alt="Category Icon"
                  />
                  <h3 className="text-[21.66px] font-normal leading-[16px] text-left">
                    {category.title}
                  </h3>
                  <p className="my-4 text-gray-300 text-[13.78px] font-normal leading-[20px] text-left line-clamp-2">
                    {category.desc}
                  </p>
                </div>
        ...
        >
          {categorieMobi.map((category, index) => (
            <SwiperSlide key={index}>
              <div
                key={index}
                className="rounded-3xl overflow-hidden p-6 bg-gray-200"
              >
                <div className="flex flex-row gap-6 h-full">
                  <div className="flex flex-col h-full flex-1">
                    <div
                    ...
                    >
                      <img
                        className="!w-6 !h-6 object-cover mb-2"
                        src={category.icon}
                        alt="Category Icon"
                      />
                      <h3 className="text-[17.27px] font-semibold">
                        {category.title}
                      </h3>
                      <p className="text-[10.99px] font-normal my-2 text-white line-clamp-3">
                        {category.desc}
                      </p>
                    </div>
                    <div className="flex mt-4">
