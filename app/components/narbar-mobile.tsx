  ...
  return (
    <div className="md:hidden flex justify-between border-b">
      <div className="flex flex-col items-center mr-2 py-4">
        <img
          className="w-6 h-6"
          src="/home-page-icon.png"
          alt="Category Icon"
        />
        <span className="text-[10px] font-semibold leading-[10px] text-center text-gray-300 mt-2">
          HOME
        </span>
      </div>
      ...
      <div className="flex flex-col items-center mr-1 text-center py-4">
        ...
        <span className="text-[10px] font-semibold leading-[10px] text-center mt-2">
          ALL GAMES
        </span>
      </div>
      <div className="flex flex-col items-center mr-2 py-4">
